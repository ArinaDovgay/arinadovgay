...
import propertyImg from "../public/assets/projects/clock.jpg";
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
          <div className="col-span-4">
            ...
            <p>
              ...
              fully adaptable to all devices. Synchronization with your time
              zone is automatic. You can also choose a theme that suits you:
              light or dark.
            </p>
            <a
              href="https://github.com/ArinaDovgay/clock"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://arinadovgay.github.io/clock/"
              target="_blank"
              rel="noreferrer"
            >
